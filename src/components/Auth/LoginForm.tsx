 ...
 *
 * Provides OAuth and email/password authentication options.
 * Supports Google, GitHub, and Azure AD OAuth providers.
 */
...
export default function LoginForm({ onSuccess }: LoginFormProps) {
  ...
  async function handleOAuthSignIn(provider: 'google' | 'github' | 'azure') {
    try {
      setError(null);
      setLoading(true);
